...
@Autonomous(name="Mabel Auto", group="Linear Opmode")
public class mabelAuto extends LinearOpMode {
        ...
        public void runOpMode() {
            ...
            if (opModeIsActive()) {
                ...
                encoderDriveDirection(0.9, 0, 0, 70);
                //go straight
                encoderDriveDirection(0.9, 10, 0, 0);
                encoderDriveDirection(0.9, 0, 0, -40);
                encoderDriveDirection(0.9, 10, 0, 0);
                encoderDriveDirection(0.9, 0, 0, -10);
                encoderDriveDirection(0.9, -25, 0, 0);
                encoderDriveDirection(0.9, 0, 0, -22);
                encoderDriveDirection(0.9, -15, 0, 0);
                // STEP 1: Drive straight FORWARD 24 inches at 50% max speed
                // For forward: all targets are positive
                encoderDriveDirection(0.9, 36, 0, 0);
                ...
                encoderDriveDirection(0.9, 0, 0, -10);
                encoderDriveDirection(0.9, -25, 0, 0);
                encoderDriveDirection(0.6, 0, 0, -23);
                // STEP 4: Do a donut
                // Turn Left targets: FL(-), BL(-), FR(+), BR(+)
